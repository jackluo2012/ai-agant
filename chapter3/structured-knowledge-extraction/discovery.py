...
from config import SCHEMA_PATH, DISCOVERY_BATCH_SIZE
...
def _chat_json(client, model, system, user):
...
def discover_schema(cases, batch_size=None, use_cache=True, verbose=True):
    ...
    Returns:
        模块化 schema，包含 core 和 extensions
    """
    ...
    for start in range(0, len(cases), batch_size):
        ...
        out = _chat_json(client, model, _BATCH_SYS, facts)
        got = out.get("factors", [])
    ...
    schema = _chat_json(client, model, _CONSOLIDATE_SYS,
