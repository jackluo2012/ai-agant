...
def test_provider_error_checkpoint_is_quarantined_with_compatibility_receipt(tmp_path):
    """含提供商错误的 checkpoint 应与兼容性回执一起进入隔离区。"""
    ...
    with pytest.raises(RuntimeError, match="提供商错误"):
