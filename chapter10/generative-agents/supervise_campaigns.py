...
def main() -> int:
    parser = argparse.ArgumentParser(description="实验臂监督与自动恢复循环")
    ...
    parser.add_argument("--python", type=Path, required=True, help="用于子进程的 Python 解释器")
    ...
    parser.add_argument("--poll-seconds", type=int, default=30, help="轮询间隔秒数")
